...
export const I18N: Record<SupportedLanguage, Translations> = {
  am: {
    ...
    ticketIssued: (num: number, title: string, amount: number, ref: string) => `🎉 *እንኳን ደስ አለዎት! ክፍያዎ ተረጋግጦ ፀድቋል!*\n\n━━━━━━━━━━━━━━━━━━━━\n🎟️ *የተቆረጠው ቲኬት:* \`#${num}\`\n🏆 *ውድድር:* *${title}*\n💰 *የተከፈለው መጠን:* *${amount} ብር*\n🔢 *የትራንዛክሽን ቁጥር (Ref):* \`${ref}\`\n━━━━━━━━━━━━━━━━━━━━\n\n✅ *ይፋዊ ቲኬትዎ በዕጣ ማውጫ ሲስተም ውስጥ ገብቷል!*\n🗓️ የዕጣ ቀን አሸናፊውን በቀጥታ እናሳውቃለን።\n\nመልካም ዕድል ይሁንልዎ! 🍀🤞`,
  ...
  om: {
    ...
    ticketIssued: (num: number, title: string, amount: number, ref: string) => `🎉 *Baga Gammaddan! Kaffaltiin Keessan Mirkanaa'eera!*\n\n━━━━━━━━━━━━━━━━━━━━\n🎟️ *Lakkoofsa Tikkeettii:* \`#${num}\`\n🏆 *Lootarii:* *${title}*\n💰 *Gatii Kaffalame:* *${amount} Birr*\n🔢 *Koodii Kaffaltii (Ref):* \`${ref}\`\n━━━━━━━━━━━━━━━━━━━━\n\n✅ *Tikkeettiin keessan sirriitti galmaa'ee carraa keessa galeera!*\n🗓️ Guyyaa carraan ba'u beeksisa isiniif ergina.\n\nCarraa Gaarii Isiniif Haa Ta'u! 🍀🤞`,
  ...
  en: {
    ...
    ticketIssued: (num: number, title: string, amount: number, ref: string) => `🎉 *CONGRATULATIONS! PAYMENT VERIFIED & ACCEPTED!*\n\n━━━━━━━━━━━━━━━━━━━━\n🎟️ *Issued Ticket:* \`#${num}\`\n🏆 *Lottery Event:* *${title}*\n💰 *Amount Paid:* *${amount} ETB*\n🔢 *Transaction Ref:* \`${ref}\`\n━━━━━━━━━━━━━━━━━━━━\n\n✅ *Your ticket is officially registered and active in the live draw!*\n🗓️ We will notify you directly when the winning numbers are drawn.\n\nBest of luck! 🍀🤞`,
